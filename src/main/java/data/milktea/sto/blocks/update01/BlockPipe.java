...
public class BlockPipe extends BlockBase
{
    ...
    public static final AxisAlignedBB PIPE_AABB_NS = new AxisAlignedBB((double) 5 / 16, (double) 5 / 16, 0D, (double) 11 / 16, (double) 11 / 16, 1D);
    ...
    {
        return ((EnumFacing) state.getValue(FACING)) == EnumFacing.SOUTH ? PIPE_AABB_NS : ((EnumFacing) state.getValue(FACING)) == EnumFacing.NORTH ? PIPE_AABB_NS : PIPE_AABB;
    }
}
